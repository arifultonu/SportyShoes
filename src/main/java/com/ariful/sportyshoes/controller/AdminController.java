package com.ariful.sportyshoes.controller;

import com.ariful.sportyshoes.model.*;
import com.ariful.sportyshoes.service.*;
	...
	private UserService userService; 
	  ...
	  @RequestMapping(value = "/adminloginaction", method = RequestMethod.POST)
	    		 ...
	    		 @RequestParam(value="admin_pwd", required=true) String adminPwd) 
	    {
		  ...
		  if (admin == null) { 
			  map.addAttribute("adminerrlogmessage", "Admin login failed. Invalid Credentials");
			  return "admin-login";
		  }
